...
import com.xavi.exams.doa.EventRepository;
import com.xavi.exams.models.Event;
...
public class CalendarController {
    ...
    List<Event> events(@RequestParam("start") @DateTimeFormat(iso = ISO.DATE_TIME) LocalDateTime start, @RequestParam("end") @DateTimeFormat(iso = ISO.DATE_TIME) LocalDateTime end) {
